...
Original file is located at
    https://colab.research.google.com/github/tensorflow/docs/blob/master/site/en/tutorials/text/nmt_with_attention.ipynb
...
en, fr = create_dataset(path_source, path_destination, None)
print(en[-1])
print(fr[-1])
...
num_examples = 5000
input_tensor, target_tensor, inp_lang, targ_lang = load_dataset(path_source, path_destination, num_examples)
